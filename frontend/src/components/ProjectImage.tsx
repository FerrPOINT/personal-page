  ...
  if (failed) {
    return (
      <div
        role="img"
        aria-label={alt}
        className={`flex h-full w-full items-center justify-center bg-gradient-to-br from-accent-cyan/20 via-surface to-accent-magenta/20 p-8 text-center ${className}`}
      >
