...
export const PROJECT_DEFINITIONS = [
  {
    ...
    "locales": {
      "ru": {
        "title": "Мультиагентная AI-система",
        "role": "Архитектор / DevOps",
        "summary": "Оркестрация 10+ автономных AI агентов с инфраструктурой RAG.",
        "context": "Спроектировал и оптимизировал сложную мультиагентную систему на LangChain и LangGraph. Система оркестрирует более 10 специализированных агентов для обработки разнообразных задач с сохранением контекста. Интегрировал RAG (Retrieval-Augmented Generation) на базе ChromaDB для снижения галлюцинаций и повышения релевантности. Отвечал за полный MLOps-контур, включая контейнеризацию агентов и масштабирование векторных баз данных.",
        "contribution": [
        ...
        "challenges": [
          "Оркестрация 10+ агентов с сохранением состояния и сложной логикой взаимодействия.",
          "Реализация RAG для больших неструктурированных наборов данных с низкой задержкой.",
          "Развёртывание AI-сервисов на Python вместе с Java-микросервисами."
        ],
        "decisions": [
        ...
        "results": [
          ...
          "Создан надёжный контейнеризированный процесс развёртывания AI-сервисов."
        ],
        "metrics": [
          {
            "value": "10+ агентов"
  ...
  },
  {
    ...
    "locales": {
      "ru": {
        ...
        "role": "Архитектор / AI-бэкенд",
        "summary": "Ассистент превращает вопросы на естественном языке в проверяемые таблицы, графики и выгрузки.",
        "context": "Спроектировал внутреннюю аналитическую платформу, в которой пользователь выбирает рабочую область и задаёт вопрос на естественном языке. Исполняемая среда строит типизированный план, разрешает метрики, периоды и фильтры, детерминированно формирует SQL, проверяет его через SQLPolicy и создаёт текст, таблицу и Plotly-график из одного валидированного результата.",
        "contribution": [
          "Спроектировал основной путь от пользовательского вопроса и маршрутизации по проектам до проверенного результата.",
          "Разделил ответственность LLM и среды исполнения: модель формирует типизированный контракт анализа, а исполняемый SQL строится только детерминированным кодом.",
          "Развивал диалоговый контекст, потоковые ответы, визуализацию, экспорт и наблюдаемость аналитического контура."
        ],
        "challenges": [
          "Не допустить исполнения произвольного или придуманного моделью SQL.",
          "Сохранять смысл связанных последующих вопросов без переноса нерелевантных фильтров между анализами.",
        ...
        "decisions": [
          ...
          "Детерминированный построитель SQL, связанные параметры и единая AST-проверка SQLPolicy образуют безопасную границу данных.",
        ...
        "results": [
          ...
          "Поддержаны изолированные диалоги, последовательный анализ, Plotly-визуализации и экспорт CSV/XLSX/PNG.",
          "Ошибки зависимостей, отсутствие данных и необходимость уточнения представлены явными безопасными результатами."
        ],
        "metrics": [
          {
            "value": "Typed IR"
  ...
  },
  {
    ...
    "media": [
      {
        ...
        "alt": {
          "ru": "Консоль OpenRTB-аукциона с лимитом 100 мс, тепловой картой ставок и лентой событий",
    ...
    "locales": {
      "ru": {
        "title": "Высоконагруженный AdTech-аукцион",
        "role": "FullStack-разработка / SRE",
        "summary": "Система реального времени для биддинга, обрабатывающая 1 миллион+ RPS на AWS.",
        "context": "Разработал высокопроизводительный OpenRTB-сервис аукциона, способный обрабатывать ~1 миллион запросов в секунду. Проект включал FullStack-разработку (CRM-интерфейс и серверную часть) и глубокую DevOps-работу на AWS. Реализовал сервисы предиктивного моделирования и оптимизировал сетевой стек для экстремальной пропускной способности. Мигрировал горячие данные в Aerospike для субмиллисекундного доступа.",
        "contribution": [
          "Разрабатывал сервис аукциона, серверные сервисы и CRM-интерфейс управления кампаниями.",
          "Оптимизировал JVM, сетевой стек и путь доступа к горячим данным.",
          "Автоматизировал инфраструктуру и развёртывание в AWS."
        ],
        "challenges": [
          "Обработка 1M+ RPS в строгих 100 мс таймаутах OpenRTB.",
        ...
        "decisions": [
          ...
          "Асинхронная обработка и настройка JVM для контроля хвостовой задержки."
        ],
        "results": [
  ...
  },
  {
    ...
    "media": [
      {
        ...
        "alt": {
          "ru": "Светлая ATS-доска с воронкой кандидатов, AI-сопоставлением и расписанием интервью",
    ...
    "locales": {
      "ru": {
        ...
        "role": "FullStack-разработка / DevOps",
        "summary": "Экосистема полного цикла рекрутинга с 4 модулями и CI/CD пайплайнами.",
        "context": "Построил комплексную HR-платформу из 4 независимых модулей (Recruiter, Candidate, Logic, AI Matching). Отвечал за FullStack-разработку (Java/Spring + React/TS) и DevOps-процесс. Реализовал модуль AI Matching с технологиями машинного обучения для интеллектуального сопоставления кандидатов и вакансий, автоматизированные алгоритмы на основе ИИ, JWT-защиту между модулями и полный GitLab CI/CD-процесс для сред разработки, тестирования и промышленной эксплуатации.",
        "contribution": [
          "Разработал серверную и клиентскую части четырёх связанных модулей платформы.",
          "Реализовал интеллектуальное сопоставление кандидатов и вакансий.",
          "Настроил единый CI/CD-процесс для сред разработки, тестирования и промышленной эксплуатации."
        ],
        "challenges": [
        ...
        "decisions": [
          ...
          "Сочетание оптимизированного SQL и ML-логики для сопоставления.",
          "Одинаковый проверяемый процесс для всех сред."
        ],
        "results": [
          "Единый автоматизированный CI/CD-процесс для всех сред.",
  ...
  },
  {
    ...
    "locales": {
      "ru": {
        ...
        "role": "Бэкенд / Инфраструктура",
        "summary": "Безопасные микросервисы для цифровых подписей и сертификатов по ГОСТ.",
        "context": "Спроектировал набор микросервисов для банковских криптографических операций. Реализовал алгоритмы ГОСТ для цифровых подписей и шифрования. Система построена на событийной архитектуре с Kafka для обработки пиков нагрузки в отчётные периоды. В зону DevOps входили оркестрация Kubernetes, Helm-чарты и усиление безопасности.",
        "contribution": [
        ...
        "challenges": [
          "Интеграция устаревших криптографических библиотек ГОСТ в современные приложения Spring Boot.",
        ...
        "results": [
          ...
          "Надёжная событийная обработка через Kafka."
        ],
        "metrics": [
          {
            "value": "ГОСТ-криптография"
          },
          {
            "value": "Kubernetes"
          },
  ...
  },
  {
    ...
    "media": [
      {
        ...
        "alt": {
          "ru": "Панель управления полным циклом разработки с фазами, процессами, CI, подтверждениями и релизными проверками",
    ...
    "locales": {
      "ru": {
        ...
        "role": "Архитектор / FullStack",
        "summary": "Единый контур от планирования задачи и работы AI-агентов до проверяемого релиза и аудита.",
        "context": "Развиваю набор самостоятельно развёртываемых сервисов Base Platform, которые закрывают полный цикл разработки продукта. Task Tracker отвечает за проекты, бэклог, спринты и канбан; Project Workflow ведёт задачу по фазам с обязательными проверками, подтверждениями и контролем руководителя; Fleet Control управляет изолированными AI-агентами и их сессиями; Wiki хранит требования, решения и доказательства; Forge CI/CD связывает отправку изменений в Git с конвейерами, согласованиями, артефактами, средами и откатом; Admin Panel управляет каталогом и общими настройками платформы.",
        "contribution": [
          ...
          "Связал процессы, выполнение AI-агентами, подтверждения и релизные проверки через устойчивые идентификаторы и аудит."
        ],
        "challenges": [
          "Сохранить трассируемость между задачей, фазой процесса, агентской сессией, коммитом, CI/CD-конвейером и подтверждениями.",
          "Изолировать среды исполнения и секреты агентов, сохранив управляемость и наблюдаемость.",
          "Развести источники истины между сервисами без дублирования изменяемого состояния."
        ],
        "decisions": [
          "Task Tracker владеет планированием, Project Workflow — фазами, Fleet Control — средами исполнения агентов, Wiki — знаниями и подтверждениями, Forge — Git и CI/CD.",
          "Неизменяемая история используется для решений руководителя, проверок, согласований и аудита.",
        ...
        "results": [
          ...
          "Проверки, подтверждения и решения сохраняются рядом с контекстом задачи и релиза.",
